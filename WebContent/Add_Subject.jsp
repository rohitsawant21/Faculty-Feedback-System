        ...
        <nav class="navbar navbar-expand-lg " id="nav-container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav  nav-pills">
                    <li class="nav-item  ">
                        <a class="nav-link " href="Staff-Home.jsp">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link active" href="Add_Subject.jsp">Add Subject</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">View Staff Feedback</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container " id="form-container">
        <div class="row ">
            <div class="col-sm " id="adminLogo">
                <h3 class="text-center">Add Subject</h3><br>
                ...
                <form action="AddSubServlet" method="post">
                    ...
                    <input type="text" name="subname" id="name"><br> <br>
            
                    <label for="subjectCode"> Subject Number :</label>
                    <input type="number" name="subnumber" id="subjectCode"><br> <br>
