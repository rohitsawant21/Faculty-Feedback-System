...
<body>
    ...
    <nav class="navbar navbar-expand-lg " id="nav-container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav  nav-pills">
          <li class="nav-item  ">
            <a class="nav-link active" href="Staff-Home.jsp">Home <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item ">
            <a class="nav-link " href="Add_Subject.jsp">Add Subject</a>
          </li>
          <li class="nav-item">
  ...
  <br>  <h1 class="text-center staff-section">Staff Section</h1>
